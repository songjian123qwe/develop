...
import HRCancelExecAction from "../../functions/HRCancelExecAction";
...
class StopDeptModal extends Component {
    ...
    saveVersionInfo() {
        ...
        HRCancelExecAction.call(this, formdata, this.props.pk_dept, this.props.pk_org)
        ...
        return (
            ...
            >
                <NCModalHeader
                    closeButton={true}
                >
                    {this.state.json['jf6005-000038']}{/* 国际化处理： 撤销部门*/}
                </NCModalHeader>
                <NCModalBody>
