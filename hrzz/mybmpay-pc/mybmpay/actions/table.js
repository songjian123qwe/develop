...
export default class TableAction {
        ...
        try {
            ...
            if (res.success) {
                ...
                allPeriod.forEach(period => {
                    const tempArea = res.data.template[period].bmdata_info;
                ...
                const sumArea = res.data.sumtemplet.bmdata_info;
    ...
    getBmPayData = async () => {
        ...
        try {
            ...
            if (res.success) {
                allPeriod.forEach(period => {
                    cardTable.setTableData(period, {rows: res.data[period].bmdata_info.rows});
                });
