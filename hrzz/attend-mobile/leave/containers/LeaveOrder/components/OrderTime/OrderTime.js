                ...
                <div className="old">
                    <section className="boxcontent">
                        ...
                        <div className="boximg">
                            <div className="timevalue">{order.breastfeedingleaveway&&order.breastfeedingleaveway.value?"":json["hrzzmb-000044"]}{order.breastfeedingleaveway&&order.breastfeedingleaveway.value?"":order.leaveday.value}{order.breastfeedingleaveway&&order.breastfeedingleaveway.value?"":order.minunit.display}</div>
                            <div className="xian">
