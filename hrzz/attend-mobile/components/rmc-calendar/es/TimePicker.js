    ...
    TimePicker.prototype.render = function render() {
        ...
        return React.createElement(
            ...
            React.createElement(DateTimePicker, { prefixCls: prefixCls, pickerPrefixCls: pickerPrefixCls, style: {
                    height: 164,
                    overflow: 'hidden'
                }, mode: mode, date: date, locale: locale, minDate: this.getMinTime(date), maxDate: this.getMaxTime(date), onDateChange: this.onDateChange, use12Hours: false, minuteStep: minuteStep })
        );
    };
